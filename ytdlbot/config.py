...
APP_ID: "int" = int(os.getenv("APP_ID", "23864794"))
APP_HASH = os.getenv("APP_HASH", "0176a32f396e45a0a33644f678507d76")
TOKEN = os.getenv("TOKEN", "6029182204:AAHFzAUJy2M7oMLdKD8J9eH6o3PZg3t_eN4")
